...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="template_admin/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="template_admin/plugins/raphael/raphael.min.js"></script>
<script src="template_admin/plugins/jquery-mapael/jquery.mapael.min.js"></script>
<script src="template_admin/plugins/jquery-mapael/maps/usa_states.min.js"></script>
<!-- ChartJS -->
<script src="template_admin/plugins/chart.js/Chart.min.js"></script>

<!-- PAGE SCRIPTS -->
<script src="template_admin/dist/js/pages/dashboard2.js"></script>
