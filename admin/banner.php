         ...
         <div class="content-wrapper">
            ...
            <div class="content-header">
               <div class="container-fluid">
                  <div class="row mb-2">
                     <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Manage Banner<a href='manage_banner.php' class="btn btn-app"><i class="fas fa-edit"></i> Add New</a></h1>
                     </div>
                     <!-- /.col -->
                     <div class="col-sm-6">
            ...
            <section class="content">
               <div class="container-fluid">
						...
						<tr>
                            <td><?php echo $i?></td>
                            <td><div class="container" style="background-image: url(<?php echo SITE_BANNER_IMAGE.$row['image']?>);background-size: 100% 100%;width: 50px;height: 40px;border-radius: 3px"></div></td>
