...
define('SERVER_RETAIL_IMAGE',SERVER_IMAGE."media/retailers/");
define('SITE_RETAIL_IMAGE',FRONT_SITE_PATH."media/retailers/");

define('SERVER_SELLER_IMAGE',SERVER_IMAGE."media/wholeseller/");
define('SITE_SELLER_IMAGE',FRONT_SITE_PATH."media/wholeseller/");
